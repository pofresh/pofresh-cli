...
consts.HELP_INFO_1 = [
    "\nFor information about Pofresh products and services, visit:",
    "   http://pofresh.netease.com/",
    "\nList of all Pofresh commands:\n"
];
...
consts.HELP_LOGIN = [
    "\nWelcome to Pofresh interactive client.",
    "Pofresh is a fast, scalable game server framework for node.js. ",
    "You can use following command to connect to pofresh master",
    "pofresh-cli -h host -P port -u user -p password",
    "Default type pofresh-cli equals to:",
    "pofresh-cli -h 127.0.0.1 -P 3005 -u admin -p admin\n"
];
...
consts.COMANDS_MAP = {
    ...
    "config": ["\nconfig infos like : proxy, remote, connection, connector, session",
        ...
        "in pofresh you can pass opt config to component to make your like-style server",
...
consts.ASCII_LOGO = [
    ".______     ______    _______ .______       _______     _______. __    __",
    "|   _  \\   /  __  \\  |   ____||   _  \\     |   ____|   /       ||  |  |  |",
    "|  |_)  | |  |  |  | |  |__   |  |_)  |    |  |__     |   (----`|  |__|  |",
    "|   ___/  |  |  |  | |   __|  |      /     |   __|     \\   \\    |   __   |",
    "|  |      |  `--'  | |  |     |  |\\  \\----.|  |____.----)   |   |  |  |  |",
